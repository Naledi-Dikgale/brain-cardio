...
const SplashPage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-indigo-300  via-purple-400 to-violet-600 text-white">
      ...
      <div className="text-4xl font-nosi mb-4">Brain-Cardio</div>
      ...
      {!showRules ? (
        ...
        <div className="text-center">
          <div className="mb-4">
            ...
            <p>1. Choose teams and pick category.</p>
            <p>2. You have 30 seconds to cover 5 terms on display.</p>
            <p>3. Explain the term to your team mates without saying the actual term.</p>
            <p>4. If you explanation is good your team mates will guess the term.</p>
            <p>5. One correct term equals one point</p>
            <p>6. The team with the most points wins!</p>
            <p>7. Click "Next" when you are ready to have some fun.</p>
          </div>
