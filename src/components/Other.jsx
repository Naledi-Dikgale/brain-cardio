...
const terms = [
  'Apple', 'Banana', 'Lenovo', 'Orange', 'Pineapple', 'Grape', 'USA', 'Mombasa', 'Monarch',
  'Strawberry', 'Blueberry', 'Raspberry', 'Blackberry', 'Cherry', 'Palestine', 'Middle East', 'Cape Town', 'Hand-Bag', 'Real Madrid', 'Mona Lisa', 'Cairo'
];
